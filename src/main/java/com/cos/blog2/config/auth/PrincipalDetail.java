package com.cos.blog2.config.auth;
...
// 스프링 시큐리티의 고유한 세션저장소에 저장을 해준다. (UserDetails 타입의 PrincipalDetail이 저장이 됨)
@Getter
public class PrincipalDetail implements UserDetails{
	...
	//계정이 갖고있는 권한 목록을 리턴한다. (권한이 여러개 있을 수 있어서 루프를 돌아야 하는데 나는 한개만)
	@Override
